...
BOT_TOKEN = environ.get('BOT_TOKEN', "7691841134:AAGdXAYQ6O9vBzmEmRn-hnXV_Lt82eOBtVg")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003705154668')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003675721060')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003705154668')  # Request channel id (make sure bot is admin)
